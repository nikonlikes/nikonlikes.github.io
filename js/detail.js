...
import { getUrlParameter, addToCart, updateCartCount, formatPrice, showNotification, getFlagIconPath } from './utils.js';
  ...
  renderKitDetails() {
    ...
    if (this.kitTitle) {
      this.kitTitle.innerHTML = `
        <img src="${getFlagIconPath(this.kit.team)}" alt="${this.kit.team} flag" class="team-flag">
